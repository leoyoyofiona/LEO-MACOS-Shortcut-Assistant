...
4. 首次启动如被 macOS 阻止，请前往“系统设置 → 隐私与安全性”，点击“仍要打开”。
5. 按引导开启“辅助功能”和“输入监控”，然后重新启动 App。

![首次安装图解](docs/images/install-guide-zh.svg)

**第一次安装建议查看：[完整图文安装教程](docs/INSTALL.md)**

> [!IMPORTANT]
> 当前是社区预览版，尚未完成 Apple Developer ID 公证。首次打开需要手动确认一次；以后可直接双击运行。不要关闭 Gatekeeper。
